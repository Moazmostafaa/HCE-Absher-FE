...
using HCE.BackgroundService.Extentions;
using HCE.BackgroundService.ImportFiles;
using HCE.WebAPI.Filters;
...
namespace HCE.WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSignalR();
            //services.AddBackGroundServiceConfigration(Configuration); //removed because it return an error (SqlException: Invalid object name 'HangFire.Hash'.)

            services.AddScoped<IImportFileJobService, ImportFileJobService>();
            services.AddScoped<IImportFileRecurringJob, ImportFileRecurringJob>();
            services.AddScoped<INpsRecurringJob, NpsRecurringJob>();
        }

        // This method gets called by the runtime. Use this method to configure the HTTP request pipeline.
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IServiceProvider serviceProvider, IOptions<AppSetting> options)
        {
            ...
            app.QueueRecurringJob(serviceProvider);
