...
namespace HCE.Persistence.Migrations
{
    ...
    [Migration("20220326182628_UpdateTheRelationOfWeightWithServiceAndKPIs")]
    partial class UpdateTheRelationOfWeightWithServiceAndKPIs
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HCE.Domain.Entities.KPIs.KPI", b =>
                {
                    ...
                    b.Property<bool>("ISKPIExperienceCustomer")
                        .HasColumnType("bit");

                    b.Property<bool>("ISKPINPS")
                        .HasColumnType("bit");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("bit");

                    b.Property<string>("KPIAbbreviation")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("KPIBadThreshold")
                        .HasColumnType("int");

                    b.Property<int>("KPICalculatedWeight")
                        .HasColumnType("int");

                    b.Property<string>("KPIDefFormula")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("KPIDefaultWeight")
                        .HasColumnType("int");

                    b.Property<string>("KPIDesc")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("KPIEntitity")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("KPIGenericFormula")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("KPIGoodThreshold")
                        .HasColumnType("int");

                    b.Property<string>("KPIName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("KPITarget")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("KPIVendorFormula")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HCE.Domain.Entities.KPIs.KPICategories", b =>
                {
                    ...
                    b.Property<Guid>("KIKPICategoryId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("KIKPICategoryId");

                    b.HasIndex("KPIId");

                    b.HasIndex("UserId");

                    b.ToTable("KPICategory", "KPIs");
                });

            modelBuilder.Entity("HCE.Domain.Entities.KPIs.KPIWeights", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HCE.Domain.Entities.Lookup.KPICategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("KPICategoryDesc")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("KPICategoryName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("IsDeleted")
                        .HasDatabaseName("IX_KPICategory_IsDeleted1");

                    b.HasIndex("UserId")
                        .HasDatabaseName("IX_KPICategory_UserId1");

                    b.ToTable("KPICategory", "General");
                });
            ...
            modelBuilder.Entity("HCE.Domain.Entities.Lookup.Weights", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HCE.Domain.Entities.Customers.CRMComplain", b =>
                {
                    b.HasOne("HCE.Domain.Entities.Customers.Customer", null)
                        .WithMany("CRMComplain")
                        .HasForeignKey("CustomerId");

                    b.HasOne("HCE.Domain.Entities.Identity.User", null)
                        .WithMany("CRMComplain")
            ...
            modelBuilder.Entity("HCE.Domain.Entities.KPIs.KPICategories", b =>
                {
                    b.HasOne("HCE.Domain.Entities.Lookup.KPICategory", "KPICategory")
                        .WithMany("KPICategories")
                        .HasForeignKey("KIKPICategoryId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("HCE.Domain.Entities.KPIs.KPIWeights", b =>
                {
                    ...
                    b.HasOne("HCE.Domain.Entities.Lookup.Weights", "Weights")
                        .WithMany("KPIWeights")
            ...
            modelBuilder.Entity("HCE.Domain.Entities.Identity.User", b =>
                {
                    b.Navigation("AccessTechnologies");
                    ...
                    b.Navigation("ExternalOperators");
                    ...
                    b.Navigation("KPI_Categories");

                    b.Navigation("MeasuringUnits");

                    b.Navigation("OperatorGroups");
