...
namespace HCE.Persistence.Migrations
{
    ...
    [Migration("20220326145906_AddKPICategories")]
    partial class AddKPICategories
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HCE.Domain.Entities.KPIs.KPI", b =>
                {
                    ...
                    b.Property<Guid>("NPSKPIWeightId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HCE.Domain.Entities.Lookup.NPSKPIWeight", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("NPSKPIWeight", "General");
                });
            ...
            modelBuilder.Entity("HCE.Domain.Entities.KPIs.KPI", b =>
                {
                    ...
                    b.HasOne("HCE.Domain.Entities.Lookup.NPSKPIWeight", "NPSKPIWeight")
                        .WithMany("KPI")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
