...
namespace HCE.Persistence.Migrations
{
    ...
    [Migration("20220412001734_npsResultCellRelation")]
    partial class npsResultCellRelation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HCE.Domain.Entities.KPIs.Kpi", b =>
                {
                    ...
                    b.Property<double>("BadThreshold")
                        .HasColumnType("float");
                    ...
                    b.Property<double>("GoodThreshold")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("HCE.Domain.Entities.KPIs.Weight", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HCE.Domain.Entities.NPS.NpsResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HCE.Domain.Entities.KPIs.Weight", b =>
                {
                    b.HasOne("HCE.Domain.Entities.KPIs.Kpi", "Kpi")
                        .WithOne("Weight")
                        .HasForeignKey("HCE.Domain.Entities.KPIs.Weight", "KpiId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("HCE.Domain.Entities.Lookup.Service", "Service")
                        .WithOne("Weight")
                        .HasForeignKey("HCE.Domain.Entities.KPIs.Weight", "ServiceId")
                        .OnDelete(DeleteBehavior.NoAction);
