...
{
    public class GetAllStateRegions : IRequest<ResponseResult<PagedResponseResult<StateRegionDto>>>, IPagedRequest
    {
        public int PageSize { get; set; }
        public int PageNumber { get; set; }

        private class Handler : IRequestHandler<GetAllStateRegions, ResponseResult<PagedResponseResult<StateRegionDto>>>
        {
            ...
            public async Task<ResponseResult<PagedResponseResult<StateRegionDto>>> Handle(GetAllStateRegions request, CancellationToken cancellationToken)
            {
                var query = _regionReadRepository.GetManyAsNoTracking(x => x.IsDeleted == false,
            ...
            public class Validator : AbstractValidator<GetAllStateRegions>
            {
                public Validator()
                {
