...
{
    public class DeleteSubSystemCommand : CommandBase<ResponseResult<bool>>
    {
        public Guid Id { get; set; }
        private class Handler : IRequestHandler<DeleteSubSystemCommand, ResponseResult<bool>>
        {
            ...
            public async Task<ResponseResult<bool>> Handle(DeleteSubSystemCommand request, CancellationToken cancellationToken)
            {
                ...
                subSystem.DeletedDate = DateTime.Now.GetCurrentDateTime();
            ...
            public class Validator : AbstractValidator<DeleteSubSystemCommand>
            {
                public Validator()
                {
