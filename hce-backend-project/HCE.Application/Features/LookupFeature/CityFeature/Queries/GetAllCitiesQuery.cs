...
{
    public class GetAllCitiesQuery : IRequest<ResponseResult<PagedResponseResult<CityDto>>>, IPagedRequest
    {
        public int PageSize { get; set; }
        public int PageNumber { get; set; }

        private class Handler : IRequestHandler<GetAllCitiesQuery, ResponseResult<PagedResponseResult<CityDto>>>
        {
            ...
            public async Task<ResponseResult<PagedResponseResult<CityDto>>> Handle(GetAllCitiesQuery request, CancellationToken cancellationToken)
            {
            ...
            public class Validator : AbstractValidator<GetAllCitiesQuery>
            {
                public Validator()
                {
