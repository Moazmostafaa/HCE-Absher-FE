...
{
    public class GetAllClustersByDistrictIdQuery : IRequest<ResponseResult<PagedResponseResult<ClusterDto>>>, IPagedRequest
    {
        public Guid DistrictId { get; set; }
        public int PageSize { get; set; }
        public int PageNumber { get; set; }

        private class Handler : IRequestHandler<GetAllClustersByDistrictIdQuery, ResponseResult<PagedResponseResult<ClusterDto>>>
        {
            ...
            public async Task<ResponseResult<PagedResponseResult<ClusterDto>>> Handle(GetAllClustersByDistrictIdQuery request, CancellationToken cancellationToken)
            {
                var query = _ReadRepository.GetManyAsNoTracking(x => x.DistrictId==request.DistrictId,
            ...
            public class Validator : AbstractValidator<GetAllClustersByDistrictIdQuery>
            {
                public Validator()
                {
