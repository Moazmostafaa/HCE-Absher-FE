...
{
    public class GetAllDistrictsByCityId : IRequest<ResponseResult<PagedResponseResult<DistrictDto>>>, IPagedRequest
    {
        public Guid CityId { get; set; }
        public int PageSize { get; set; }
        public int PageNumber { get; set; }

        private class Handler : IRequestHandler<GetAllDistrictsByCityId, ResponseResult<PagedResponseResult<DistrictDto>>>
        {
            ...
            public async Task<ResponseResult<PagedResponseResult<DistrictDto>>> Handle(GetAllDistrictsByCityId request, CancellationToken cancellationToken)
            {
                var query = _ReadRepository.GetManyAsNoTracking(x => x.CityId == request.CityId,
            ...
            public class Validator : AbstractValidator<GetAllDistrictsByCityId>
            {
                public Validator()
                {
