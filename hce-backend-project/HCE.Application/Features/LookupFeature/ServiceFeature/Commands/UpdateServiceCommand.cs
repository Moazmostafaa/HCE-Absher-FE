...
{
    public class UpdateServiceCommand: CommandBase<ResponseResult<ServiceDto>>
    {
        ...
        private class Handler : IRequestHandler<UpdateServiceCommand, ResponseResult<ServiceDto>>
    {
      ...
      IReadRepository<User> userReadRepository)
        ...
        {
            var service = await _read.GetAsync(x => x.Id == request.ServiceId);
            if (service == null)
            ...
            service.ServiceDesc = request.ServiceDesc;
                ...
                service.UpdatedDate = DateTime.Now.GetCurrentDateTime();
