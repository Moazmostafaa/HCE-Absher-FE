...
@Component({
  selector: "ngx-userschats",
  templateUrl: "./userschats.component.html",
  styleUrls: ["./userschats.component.scss"],
})
...
export class UserschatsComponent implements OnInit {
  ...
  getAllChats() {
    this.loading = true;
    this.chatService.getUsersChats(this.searchModal).subscribe((res: any) => {
