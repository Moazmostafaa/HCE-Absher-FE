...
namespace HCE.Persistence.Extentions
{
    public static class SeedExtentions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Modules>().HasData(new Modules()
            {
                ModuleId = 2,//new Guid("2a4e1c34-aff9-41c2-b046-0f25643a3c1f"),
                ModuleCode = "Chat",
                ModuleName = "Chat",
                CreatedDate = new DateTime(2021, 11, 9, 0, 43, 49, 480, DateTimeKind.Local),
                CreatedBy = "2a4e1c24-aff9-41c2-b046-0f25613a3c1f",
            ...
            modelBuilder.Entity<Modules>().HasData(new Modules()
            {
                ModuleId = 3,//new Guid("2a4e1c35-aff9-41c2-b046-0f25643a3c1f"),
                ModuleCode = "Events",
                ModuleName = "Events",
                CreatedDate = new DateTime(2021, 11, 9, 0, 43, 49, 480, DateTimeKind.Local),
                CreatedBy = "2a4e1c24-aff9-41c2-b046-0f25613a3c1f",
            ...
            modelBuilder.Entity<Modules>().HasData(new Modules()
            {
                ModuleId = 4,//new Guid("2a4e1c36-aff9-41c2-b046-0f25643a3c1f"),
                ModuleCode = "KnowledgCenter",
                ModuleName = "Knowledge Center",
                CreatedDate = new DateTime(2021, 11, 9, 0, 43, 49, 480, DateTimeKind.Local),
                CreatedBy = "2a4e1c24-aff9-41c2-b046-0f25613a3c1f",
            });
            modelBuilder.Entity<Modules>().HasData(new Modules()
            {
                ModuleId = 5,//new Guid("2a4e1c37-aff9-41c2-b046-0f25643a3c1f"),
                ModuleCode = "Tasks",
                ModuleName = "Tasks",
                CreatedDate = new DateTime(2021, 11, 9, 0, 43, 49, 480, DateTimeKind.Local),
                CreatedBy = "2a4e1c24-aff9-41c2-b046-0f25613a3c1f",
            ...
            modelBuilder.Entity<Modules>().HasData(new Modules()
            {
                ModuleId = 6,//new Guid("2a4e1c38-aff9-41c2-b046-0f25643a3c1f"),
                ModuleCode = "User",
                ModuleName = "User",
                CreatedDate = new DateTime(2021, 11, 9, 0, 43, 49, 480, DateTimeKind.Local),
                CreatedBy = "2a4e1c24-aff9-41c2-b046-0f25613a3c1f",
