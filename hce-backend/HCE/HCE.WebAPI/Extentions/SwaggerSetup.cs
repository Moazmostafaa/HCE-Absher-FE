    ...
    public static class SwaggerSetup
    {
        public static void AddSwaggerSetup(this IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(swagger =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Absher interior",
                    Description = "Absher interior v1 web api."
                });
        ...
        public static void UseSwaggerSetup(this IApplicationBuilder app, IWebHostEnvironment env, AppSetting appSettings)
        {
            ...
            if (env.EnvironmentName is "Moi-Test" or "Moi-Dev")
            {
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint($"{appSettings.GatewayPrefix}/swagger/v1/swagger.json", "Absher");
            ...
            else
            {
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Absher");
                    c.DocExpansion(DocExpansion.List);
                });
            }
        }
